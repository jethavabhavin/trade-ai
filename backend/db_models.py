...
from sqlalchemy import Column, String, Boolean, Float, DateTime, Text, Integer, ForeignKey, UniqueConstraint
...
class PineScriptDB(Base):
    """
    Persistent database schema for user-created and AI-generated TradingView Pine Script v5 algorithms.
    """
    __tablename__ = "pine_scripts"
    __table_args__ = {'extend_existing': True}

    id = Column(String(64), primary_key=True, index=True) # e.g. ps_usr_demo_01_1727000000
    ...
    pine_version = Column(String(16), default="v5")
    code = Column(Text, nullable=False)
    description = Column(Text, nullable=True)
    inputs_json = Column(Text, nullable=True, default="{}")
    backtest_stats_json = Column(Text, nullable=True, default="{}")
